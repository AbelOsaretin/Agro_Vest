      ...
      <main className="w-full grid md:grid-cols-2 gap-6">
        ...
        <div className="w-full md:col-span-2 grid md:grid-cols-2 lg:gap-12 gap-6 bg-darkgreen md:rounded-t-3xl md:px-12 px-8 md:py-12 py-10">
          <div className="order-2 md:order-1 flex flex-col justify-center gap-4">
            <h1 className="md:text-4xl text-4xl text-lightgreen font-semibold">
              Our Offers
            </h1>
            <h4 className="text-2xl text-gray-200 capitalize font-medium">
        ...
        <div className="flex flex-col gap-4 bg-lightgreen/[40%] md:rounded-bl-3xl md:px-12 px-8 md:py-12 py-10">
          ...
          <h1 className="md:text-2xl text-xl text-darkgreen font-medium capitalize">
            Dynamic marketplace
          </h1>
